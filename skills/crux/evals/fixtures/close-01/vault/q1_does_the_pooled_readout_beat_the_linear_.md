...
type: question
schema: 2
title: Does the pooled readout beat the linear one?
parent: root
status: open
stale: false
...
# q1 — Does the pooled readout beat the linear one?

Parent:: [[close_fixture]]
...
Does the pooled readout beat the linear one?
...
- `h1` [[h1_the_pooled_readout_beats_the_linear_one_|the pooled readout beats the linear one by at least 0.02 mIoU]] — *running*
<!-- crux:ledger:end -->
